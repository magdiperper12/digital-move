...
const InfiniteMarquee: React.FC = () => {
	...
	return (
		<div
			className='text-center -mt-56  text-white  '
			dir='ltr'>
			{/* Section Title */}
			<div className='w-full m-auto  '>
				...
				<motion.h2
					...
					className='text-5xl  text-gradient bg-gradient-to-r from-gray-50 to-gray-500 bg-clip-text text-transparent font-extrabold mb-16 text-center'>
					WHAT OUR CLIENT <span className=''>SAY</span>
				...
				<motion.div
					...
					{[...testimonials, ...testimonials].map((item, idx) => (
						<div
							...
							<p className='text-[18px] text-[#b4fffd] text-wrap'>
								{item.review}
							</p>
						</div>
					))}
