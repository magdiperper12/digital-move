  ...
  return (
    <footer className="w-full z-50 text-white px-8 py-12 md:px-20">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-800 pb-12">
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex border-b border-gray-600 items-center">
              ...
              />
              <button className="text-indigo-400 hover:text-indigo-300 transition-all">
                →
              </button>
            </div>
          </div>
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold tracking-wider">
            WORK<span className="text-indigo-400">.</span>
          </h2>
      ...
      >
        <h2 className="text-5xl md:text-6xl font-bold tracking-wider">
          LET’S TALK<span className="text-indigo-400">.</span>
        </h2>
      </motion.div>
    </footer>
  );
